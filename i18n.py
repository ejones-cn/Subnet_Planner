...
TRANSLATIONS = {
    ...
    "is_link_local": {"zh": "是否链路本地", "en": "Is Link Local"},
    "is_loopback": {"zh": "是否回环地址", "en": "Is Loopback"},
    "is_multicast": {"zh": "是否组播地址", "en": "Is Multicast"},
    "is_unspecified": {"zh": "是否未指定地址", "en": "Is Unspecified"},
    "is_reserved": {"zh": "是否保留地址", "en": "Is Reserved"},
    "is_ipv4_mapped": {"zh": "是否IPv4映射", "en": "Is IPv4 Mapped"},
    ...
    "subnet_mask": {"zh": "子网掩码", "en": "Subnet Mask"},
    "broadcast_address": {"zh": "广播地址", "en": "Broadcast Address"},
    "host_count": {"zh": "主机数", "en": "Host Count"},
    ...
    "is_global": {"zh": "是否全局可路由", "en": "Is Globally Routable"},
    "is_private": {"zh": "是否私有地址", "en": "Is Private Address"},
    "is_link_local": {"zh": "是否链路本地", "en": "Is Link Local"},
    "is_loopback": {"zh": "是否回环地址", "en": "Is Loopback Address"},
    "is_multicast": {"zh": "是否组播地址", "en": "Is Multicast Address"},
    "is_unspecified": {"zh": "是否未指定地址", "en": "Is Unspecified Address"},
    "is_reserved": {"zh": "是否保留地址", "en": "Is Reserved Address"},
    "is_ipv4_mapped": {"zh": "是否IPv4映射", "en": "Is IPv4 Mapped"},
    "address_structure": {"zh": "地址结构分析", "en": "Address Structure Analysis"},
    "prefix_analysis": {"zh": "前缀分析", "en": "Prefix Analysis"},
    "row_number": {"zh": "行号", "en": "Row Number"},
    "subnet_name": {"zh": "子网名称", "en": "Subnet Name"},
    "usable_address_count": {"zh": "可用地址数", "en": "Usable Address Count"},
    "split_segment": {"zh": "切分网段", "en": "Split Segment"},
    ...
    "copyright": {"zh": "© 2025 {app_name}", "en": "© 2025 {app_name}"},
    ...
    "subnet_already_exists": {"zh": "子网名称已存在", "en": "Subnet name already exists"},
    "valid": {"zh": "有效", "en": "Valid"},
    "invalid": {"zh": "无效", "en": "Invalid"},
    "row_number": {"zh": "行号", "en": "Row"},
    
    # 其他
    "msg_already_exists": {"zh": "中已存在名称为 '{name}' 的记录", "en": "already contains a record named '{name}'"},
    "decimal_value_representation": {"zh": "十进制数值表示", "en": "Decimal Value Representation"},
    "value_representation": {"zh": "数值表示", "en": "Value Representation"},
    ...
    # IP属性
    "is_private": {"zh": "是否私有IP", "en": "Is Private IP"},
    "is_reserved": {"zh": "是否保留IP", "en": "Is Reserved IP"},
    "is_loopback": {"zh": "是否回环地址", "en": "Is Loopback Address"},
    "is_multicast": {"zh": "是否组播地址", "en": "Is Multicast Address"},
    "is_global": {"zh": "是否全局可路由", "en": "Is Globally Routable"},
    "is_link_local": {"zh": "是否链路本地地址", "en": "Is Link Local Address"},
    "is_unspecified": {"zh": "是否未指定地址", "en": "Is Unspecified Address"},
    "is_private_address": {"zh": "是否私有地址", "en": "Is Private Address"},
    "is_ipv4_mapped": {"zh": "是否IPv4映射", "en": "Is IPv4 Mapped"},
    ...
    "loopback_address": {"zh": "回环地址 (::1/128)", "en": "Loopback Address (::1/128)"},
    "unspecified_address": {"zh": "未指定地址 (::/128)", "en": "Unspecified Address (::/128)"},
    ...
    "purpose_global_unicast": {"zh": "可在全球范围内路由，用于公网通信", "en": "Globally routable, used for public network communication"},
    ...
    "partial_overlap": {"zh": "部分重叠", "en": "partial overlap"},
    
    # Section headers
    "section_address_range": {"zh": "地址范围", "en": "Address Range"},
    "section_binary_representation": {"zh": "二进制表示", "en": "Binary Representation"},
    "section_hexadecimal_representation": {"zh": "十六进制表示", "en": "Hexadecimal Representation"},
    "section_decimal_representation": {"zh": "十进制数值表示", "en": "Decimal Value Representation"},
    "section_ip_properties": {"zh": "IP属性", "en": "IP Properties"},
    "section_extended_info": {"zh": "扩展信息", "en": "Extended Info"},
    ...
    "advice_private_network": {"zh": "建议使用DHCP服务器自动分配IP地址", "en": "It is recommended to use DHCP server for automatic IP address assignment"},
