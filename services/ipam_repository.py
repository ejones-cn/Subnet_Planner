...
class IPAMRepository:
    ...
    def update_ip_status(self, ip_id, status, description=None):
        return self.ipam.update_ip_status(ip_id, status, description)

    def delete_ip(self, ip_id):
        return self.ipam.delete_ip(ip_id)
    ...
    def get_ip_by_id(self, ip_id):
        return self.ipam.get_ip_by_id(ip_id)
    ...
    def release_ip(self, ip_id):
        return self.ipam.release_ip(ip_id)
    ...
    def set_ip_expiry(self, ip_id, expiry_date):
        return self.ipam.set_ip_expiry(ip_id, expiry_date)
    ...
    def batch_set_expiry_date(self, ip_ids, expiry_date):
        return self.ipam.batch_set_expiry_date(ip_ids, expiry_date)
